...
return {
	...
	keys = {
		{ key = "C", mods = meh, action = act.CopyTo("Clipboard") },
		{ key = "V", mods = meh, action = act.PasteFrom("Clipboard") },
		...
		{ key = "F", mods = meh, action = act.Search({ CaseInSensitiveString = "hash" }) },
		{ key = "X", mods = meh, action = act.ActivateCopyMode },
		{ key = "Space", mods = meh, action = act.QuickSelect },
